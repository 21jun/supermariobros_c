...
enum BackGroundObj { SMALL_CLOUD, SMALL_BUSH, PIPE_TOP, PIPE_BODY, KOOPA, DOOR,DOORWHITE, DOORWHITEREVERSE, BRICK,BRICK_GRAY, BRICK_BLUE,THORN, HAMMER, DOORBOSS, STAR, COIN};